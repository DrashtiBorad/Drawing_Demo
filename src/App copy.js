...
const App = () => {
  ...
  const handleMouseDown = (e) => {
    ...
    // check if user clicked on plain stage and not on any other object
    const canDeSelectTheShape =
      e.target === e.target.getStage() || e.target.attrs?.id === "bgImage";
    ...
    if (canDeSelectTheShape) setSelectedShape(null);
  };
  ...
  return (
    ...
    >
      ...
      <div className="mfev-relative">
        ...
        >
          <Layer>
            {bgImage && <ImageFromLink imageLink={bgImage} id="bgImage" />}
